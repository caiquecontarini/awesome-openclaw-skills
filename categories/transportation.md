...
- [constraint-engine](https://github.com/openclaw/skills/tree/main/skills/leegitw/constraint-engine/SKILL.md) - Learn from consequences, not instructions â€” generate and enforce constraints from experience.
...
- [daai-xianzun-persona](https://github.com/openclaw/skills/tree/main/skills/kunwl123456/daai-xianzun-persona/SKILL.md) - The persona of Da Ai Xian Zun (å¤§çˆ±ä»™å°Š) - Gu Yue Fang Yuan from the novel Reverend Insanity.
...
- [feature-forge](https://github.com/openclaw/skills/tree/main/skills/guifav/feature-forge/SKILL.md) - Generates complete features from natural language â€” components, API routes, migrations, types, and tests.
...
- [garmin-skill](https://github.com/openclaw/skills/tree/main/skills/nftechie/garmin-skill/SKILL.md) - Talk to your Garmin data â€” ask questions about your activities, training load, VO2 Max, heart rate zones.
- [geomanic](https://github.com/openclaw/skills/tree/main/skills/weltspion/geomanic/SKILL.md) - Query and manage GPS travel data from Geomanic â€” your privacy-first GPS tracking platform.
...
- [greek-compliance-aade](https://github.com/openclaw/skills/tree/main/skills/satoshistackalotto/greek-compliance-aade/SKILL.md) - Greek tax compliance with AADE/TAXIS integration â€” VAT, payroll, EFKA, municipal taxes, stamp duty.
...
- [metra](https://github.com/openclaw/skills/tree/main/skills/brianleach/metra/SKILL.md) - Chicago Metra commuter rail â€” real-time train arrivals, vehicle tracking, service alerts, and schedule info.
- [mta](https://github.com/openclaw/skills/tree/main/skills/brianleach/mta/SKILL.md) - NYC MTA transit â€” real-time subway arrivals, bus predictions, service alerts, and route info for the New York City.
...
- [nyx-archive-absurdist-play](https://github.com/openclaw/skills/tree/main/skills/nyxur42/nyx-archive-absurdist-play/SKILL.md) - The philosophy of absurdist play â€” the meta-skill that trains your ability to acquire and use all other skills.
...
- [tfl](https://github.com/openclaw/skills/tree/main/skills/brianleach/tfl/SKILL.md) - London TfL transit â€” real-time Tube arrivals, bus predictions, line status, service disruptions, journey planning.
...
- [ubtrippin](https://github.com/openclaw/skills/tree/main/skills/fistfulayen/ubtrippin/SKILL.md) - Manages travel for your user via UBTRIPPIN â€” reads trips, items, and booking details.
...
- [void-atlas-protocol](https://github.com/openclaw/skills/tree/main/skills/deepseekoracle/void-atlas-protocol/SKILL.md) - Void Atlas Protocol â€“ a four-axis ethical navigation map (power, truth, sovereignty, care) with waypoints, routes.
